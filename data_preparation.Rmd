...
largest_component <- function(sf){
  ...
  largest_component_id <- which.max(sapply(decompose(a), length))

  # export the largest component as an sfnetwork
  largest_component<- components[[largest_component_id]] %>% as_sfnetwork()
